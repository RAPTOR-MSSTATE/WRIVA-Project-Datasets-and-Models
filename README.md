...
The Google Drive link contains individual folders for the rain, soil, and finger-in-lense datasets. These folders all have the annotations and working models created for each dataset.
